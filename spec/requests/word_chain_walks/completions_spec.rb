...
RSpec.describe 'WordChainWalks::Completions', type: :request do
  ...
  describe 'PATCH /word_chain_walks/:word_chain_walk_id/completion' do
    it '進行中の散歩を任意完了できること' do
      log_in(user)
      expect do
        patch word_chain_walk_completion_path(word_chain_walk), params: { word_chain_walk: { finish_latitude: 35.681236, finish_longitude: 139.767125 } }
    ...
    it '他人の散歩を任意完了できないこと' do
      log_in(user)
      expect do
        patch word_chain_walk_completion_path(other_word_chain_walk), params: { word_chain_walk: { finish_latitude: 35.681236, finish_longitude: 139.767125 } }
    ...
    it '完了済みの散歩に再完了リクエストしても完了状態のままであること' do
      log_in(user)
      patch word_chain_walk_completion_path(finished_word_chain_walk), params: { word_chain_walk: { finish_latitude: 35.681236, finish_longitude: 139.767125 } }
